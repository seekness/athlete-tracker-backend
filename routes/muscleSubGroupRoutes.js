...
router.post("/", authenticateToken, checkRole(['admin', 'trener']), muscleSubGroupController.createMuscleSubGroup);
router.put("/:id", authenticateToken, checkRole(['admin', 'trener']), muscleSubGroupController.updateMuscleSubGroup);
