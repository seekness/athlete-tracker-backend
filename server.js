...
// app.get(
//   "/api/assigned-programs/athletes",
//   authenticateToken,
//   async (req, res) => {
//     const userRole = req.user.role;
//     const userId = req.user.id;
